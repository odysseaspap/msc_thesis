...
class RadNet:
    ...
    def _build_model(self):
        ...
        with tf.name_scope('calibration_block'):
            ...
            # The following can be used when training with the the onlyYAW dataset
            # Set pitch and roll components of quaternion to zero since they are not relevant in training - minor improvement
